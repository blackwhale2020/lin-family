...
// 第一個人物：修改數字為 0-10, 0 為小舅舅，9為美國姨丈
let firstFruit = 0;
...
const minRandomFruitNum = reverseLevelUp ? 6 : 0; // 生成隨機人物最小值（0-10）0 為小舅舅，9 為美國姨丈
const maxRandomFruitNum = reverseLevelUp ? 11 : 5; // 生成隨機人物最大值（1-11）0 為小舅舅，9 為美國姨丈
let setFruits = {
  // 指定前幾次生成的人物，可填入任意數量的數字，0 為小舅舅，9 為美國姨丈
...
// 修改網頁標題：將 "合成大西瓜" 進行替換
document.getElementsByTagName("title")[0].innerText = '合成林家族';
